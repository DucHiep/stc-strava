...
public interface RunRepositoy extends JpaRepository<Run,Long> {
    List<Run> findAllByPaceAndDateAndTotalPoint(double pace, LocalDateTime date, double totalPoint);
    ...
    List<Run> statistic(LocalDateTime fromDate, LocalDateTime toDate);
}
